...
<Info>
This page is the **direct-mode** reference: it documents the Daraja API contract for ISPs that bring their own Paybill or Till. Most ISPs operate on **centralized mode** instead, where FyberPay's shared Paybill (`4026145`) collects on their behalf and no Daraja credentials are needed. See [M-Pesa Integration → Centralized vs Direct](/guides/mpesa-integration) for which mode applies to you.
</Info>
