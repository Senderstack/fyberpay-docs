---
title: Billing Setup
description: Configure invoicing, payment terms, tax, billing cycles, settlement destination, and platform fees.
...
ISPs running their own Daraja credentials in **direct mode** pay no transaction fee here. See [M-Pesa Integration → Centralized vs Direct](/guides/mpesa-integration) for the choice between modes.
