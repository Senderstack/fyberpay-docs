...
description: Centralized vs direct paybill, settlement destinations, Daraja credentials, STK Push, C2B, and reconciliation.
lastReviewed: 2026-05-14
---

import ChatWidget from '/snippets/chat-widget.mdx';
...
|---|---|---|---|---|
| **Centralized** (default) | FyberPay's M-Pesa Paybill `4026145` | Not required | 1% deducted on each successful payment | Next business day to the ISP's configured settlement destination (M-Pesa Paybill, Till, or bank-via-Tuma) |
